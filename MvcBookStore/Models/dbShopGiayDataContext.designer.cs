...
namespace MvcBookStore.Models
{
    ...
    partial void DeleteVIETSACH(VIETSACH instance);
		...
		public dbShopGiayDataContextDataContext() : 
				base(global::System.Configuration.ConfigurationManager.ConnectionStrings["QLBANGIAYConnectionString1"].ConnectionString, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OntenaccChanging(string value);
    partial void OntenaccChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_pwd", DbType="VarChar(30) NOT NULL", CanBeNull=false)]
		public string pwd
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_tenacc", DbType="NVarChar(50)")]
		public string tenacc
		{
			...
			set
			{
				...
				{
					this.OntenaccChanging(value);
					this.SendPropertyChanging();
					this._tenacc = value;
					this.SendPropertyChanged("tenacc");
					this.OntenaccChanged();
				}
			}
		}
    ...
    partial void OnMaNSXChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="GIAY_VIETSACH", Storage="_VIETSACHes", ThisKey="MaGiay", OtherKey="MaGiay")]
    ...
    partial void OnVitriChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="GIAY_VIETSACH", Storage="_GIAY", ThisKey="MaGiay", OtherKey="MaGiay", IsForeignKey=true)]
		public GIAY GIAY
		{
			get
			{
